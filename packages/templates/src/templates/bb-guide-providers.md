...
The builtin Provider retry plugin recognizes structured Codex and Claude Code
subscription windows. It is enabled on fresh installations; disable it under
Extensions → Plugins or run `bb plugin disable provider-retry`. If a provider
